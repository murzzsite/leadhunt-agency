(() => {
  // ===== CONFIG =====
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/YK42RYKYUY';
  ...
  const targets = document.querySelectorAll(
    '.adv, .srv, .step, .object, .review, .contact-card, .faq__item, .form, .hero__card, .principle, .service, .compare__card'
  );
